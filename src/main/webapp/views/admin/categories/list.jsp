	...
	<div class="container">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item">
							<a class="nav-link  active" href="${pageContext.request.contextPath}/admin/categories">Quản lý loại tin</a>
						</li>
						<li class="nav-item">
		...
		<main>
			...
			<div class="card">
				...
				<div class="card-body">
					<a href="${pageContext.request.contextPath}/admin/categories/add" class="btn btn-primary float-end">Thêm mới</a>
					<table class="table">
						<thead>
							<tr>
								<th scope="col">Id</th>
						...
						<tbody>
							...
							<tr>
								...
								<td>${cate.name}</td>
								<td>
									<a href="${pageContext.request.contextPath}/admin/categories/edit?id=${cate.id}" class="btn btn-success">Chỉnh sửa</a> | 
									<a href="${pageContext.request.contextPath}/admin/categories/delete?id=${cate.id}" class="btn btn-danger">Xóa</a>
								</td>
							</tr>
							</c:forEach>
						</tbody>
