			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item">
							<a class="nav-link active"  href="${pageContext.request.contextPath}/admin/news">Quản lý tin tức</a>
						</li>
						<li class="nav-item">
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<img src="${pageContext.request.contextPath}/images/${tintuc.image}" width="50" height="50"/>
									
								</td>
								<td>${tintuc.title}</td>
								<td>${tintuc.categoryName}</td>
								<td>${tintuc.postedDate}</td>
								<td>${tintuc.home?'đã duyệt':'chờ duyệt'}</td>
								<td>
									<c:if test="${!tintuc.home}">
									<a href="${pageContext.request.contextPath}/admin/news/duyet?id=${tintuc.id}" class="btn btn-success">Duyệt</a> | 
									</c:if>
									<c:if test="${tintuc.home}">
									<a href="${pageContext.request.contextPath}/admin/news/khoa?id=${tintuc.id}" class="btn btn-success">Khóa</a> | 
									</c:if>
									<a href="${pageContext.request.contextPath}/admin/news/xoa?id=${tintuc.id}" class="btn btn-danger">Xóa</a>
								</td>
							</tr>
							</c:forEach>
						</tbody>
