	...
	<div class="container">
		...
		<main>
			...
			<div class="card">
				...
				<div class="card-body">
					<a href="${pageContext.request.contextPath}/phong-vien/tin-tuc/them-moi" class="btn btn-primary float-end">Thêm mới</a>
					<table class="table">
						<thead>
							<tr>
								<th scope="col">Id</th>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="${pageContext.request.contextPath}/phong-vien/tin-tuc/chinh-sua?id=${tintuc.id}" class="btn btn-success">Chỉnh sửa</a> | 
									<a href="${pageContext.request.contextPath}/phong-vien/tin-tuc/xoa?id=${tintuc.id}" class="btn btn-danger">Xóa</a>
								</td>
							</tr>
							</c:forEach>
						</tbody>
